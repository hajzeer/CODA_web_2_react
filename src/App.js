  ...
  state = {
    services: [
      {title: 'MONITORING',img:kamera,
        disc:'Kamery są podłączone do sieci więc możesz sprawdzać je w dowolnym czasie i dowolnym miejscu. Czuj się bezpiecznie z monitoringiem, który założymy dla Ciebie z najwyższą jakością.',
        id:0 },
      ...
      {title: 'INTERNET',img:internet,
          disc:'Jest to dziedzina, w której możemy pochwalić się największym doświadczeniem. Wszyscy nasi klienci zaufali naszej jakości pracy. Ty również możesz nam zaufać i powierzyć nam stworzenie własnej sieci lokalnej już dziś.',
          id:2 },
      {title: 'DOMOFONY',img:domofon,
         disc:'Jesteś właścicielem kamienicy lub należysz do zarządu wspólnoty? Zaufało nam już wielu właścicieli kamienic w Chorzowie oraz Siemianowicach Śląskich. Dołącz do ich grona już dziś.',
         id:3 },
    ],
    partners: [
